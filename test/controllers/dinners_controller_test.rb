...
class DinnersControllerTest < ActionController::TestCase
  ...
  test "should create dinner" do
    assert_difference('Dinner.count') do
      post :create, dinner: { date: @dinner.date, description: @dinner.description, image: @dinner.image, title: @dinner.title }
    end
  ...
  test "should update dinner" do
    patch :update, id: @dinner, dinner: { date: @dinner.date, description: @dinner.description, image: @dinner.image, title: @dinner.title }
    assert_redirected_to dinner_path(assigns(:dinner))
  end
